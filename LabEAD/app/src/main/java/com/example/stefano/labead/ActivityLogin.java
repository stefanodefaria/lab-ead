...
public class ActivityLogin extends Activity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * Keep track of the loginRequest task to ensure we can cancel it if requested.
     */
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            // perform the user loginRequest attempt.
            showProgress(true);
    ...
    /**
     * Represents an asynchronous loginRequest/registration task used to authenticate
     * the user.
     */
